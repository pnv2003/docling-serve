...
| [`ghcr.io/docling-project/docling-serve-cu121`](https://github.com/docling-project/docling-serve/pkgs/container/docling-serve-cu121) <br> [`quay.io/docling-project/docling-serve-cu121`](https://quay.io/repository/docling-project/docling-serve-cu121) | CUDA 12.1 build with `torch` from the cu121 index. | `linux/amd64` | 9.5 GB |
